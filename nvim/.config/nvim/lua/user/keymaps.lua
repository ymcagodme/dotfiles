...
-- Custom functions
keymap('n', '<leader>sv', require('user.telescope').search_nvim_config, { desc = '[S]earch [V]imrc' })
keymap('n', '<leader>sdf', require('user.telescope').search_dotfiles, { desc = '[S]earch [D]ot[F]iles' })
